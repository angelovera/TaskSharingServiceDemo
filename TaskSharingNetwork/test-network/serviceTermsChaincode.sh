...
# package
peer lifecycle chaincode package serviceTerms.tar.gz --path ../../../../eclipse-workspace/ServiceTermsChaincode_1/lib/build/install/lib --lang java --label serviceTermsV0
