...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    ${CONTAINER_CLI} volume rm docker_orderer.tasksharingnet.com docker_peer0.org1.tasksharingnet.com docker_peer0.org2.tasksharingnet.com docker_peer0.org3.tasksharingnet.com docker_peer0.org4.tasksharingnet.com docker_peer0.org5.tasksharingnet.com
